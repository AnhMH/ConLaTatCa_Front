...
<li class="menu-item <?php echo !empty($cate['sub_cates']) ? 'herald-mega-menu' : '';?>">
    <a href="<?php echo $BASE_URL;?>/cates/<?php echo $cate['url'];?>"><?php echo $cate['name'];?></a>
            ...
            <div class="row">
                <div class="col-lg-3 herald-mega-menu-sub-cats">
                    <ul>
                        ...
                        <li><a href="<?php echo $BASE_URL;?>/cates/<?php echo $subCate['url']; ?>"><?php echo $subCate['name']; ?></a></li>
                        <?php endforeach; ?>
                    </ul>
                </div>
                    ...
                    <div class="row row-eq-height">
                        ...
                        <article class="herald-lay-i post type-post status-publish format-standard has-post-thumbnail hentry">
                            <div class="herald-post-thumbnail herald-format-icon-small">
                                <a href="<?php echo $BASE_URL;?>/articles/<?php echo $da['url']; ?>" title="<?php echo $da['name']; ?>">
                            ...
                            <div class="entry-header">
                                <span class="meta-category meta-small"><a href="<?php echo $BASE_URL;?>/articles/<?php echo $da['url']; ?>" class="herald-cat-<?php echo $da['cate_id'];?>"><?php echo $da['cate_name'];?></a></span>

                                <h2 class="entry-title h6"><a href="<?php echo $BASE_URL;?>/articles/<?php echo $da['url']; ?>"><?php echo $da['name']; ?></a></h2>
